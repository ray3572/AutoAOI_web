...
## [痛点问题]({{ base_path }}/why_autoaoi/)
## [技术路线]({{ base_path }}/how_autoaoi/)
## [当前效果]({{ base_path }}/autoaoi_demo/)
## [未来规划]({{ base_path }}/autoaoi_routingmap/)
## [特别致谢合作团队]({{ base_path }}/autoaoi_authors/)
## [背景知识]({{ base_path }}/autoaoi_background/)
